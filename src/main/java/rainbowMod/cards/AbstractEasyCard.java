...
import rainbowMod.util.CardArtRoller;

import static rainbowMod.RainbowMod.*;
import static rainbowMod.util.Wiz.atb;
import static rainbowMod.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, TheRainbow.Enums.RAINBOW_CARD_COLOR);
    }
